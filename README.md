...
The Microservice was developed for my study, to demonstrate how to solve the [AnotaAi Backend Challenge](https://github.com/githubanotaai/new-test-backend-nodejs).
...
```bash
git clone https://github.com/Fpereiraaraujo/desafio-anota-ai-pleno
```
